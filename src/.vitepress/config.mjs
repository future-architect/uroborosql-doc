  ...
  "/": [
    ...
    },
    {
      ...
      items: [
        ...
        getLinkItem("/configuration/sql-context-factory.html"),
        getLinkItem("/configuration/sql-agent-factory.html"),
        getLinkItem("/configuration/sql-manager.html"),
        getLinkItem("/configuration/sql-filter-manager.html"),
        getLinkItem("/configuration/entity-handler.html"),
