...
| **transformationType** | String         |      | AES/ECB/PKCS5Padding | 変換の名前（例: DES/CBC/PKCS5Padding）。標準の変換名については、[Java暗号化アーキテクチャー標準アルゴリズム名](https://docs.oracle.com/javase/jp/11/docs/specs/security/standard-names.html#cipher-algorithm-names)のドキュメントを参照 |
